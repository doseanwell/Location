...
int main()
{
    ...
    //    input <<
    //
    0.166704003, 0.793647502, 0.585092658, -0.836314314, -0.495913423, 0.233769642, 0.202316318, 0.528412458,
        0.824529188, -0.85625963, -0.222778842, 0.466035443, 0.221061031, -0.715468667, -0.662749279, 0.922008461,
        0.260256615, 0.28664768, 3.344844582, 0.94415395, 1.039894947, 2.136208297, -1.528755739, -2.820955601,
        -0.750271, 2.003565, -1.070326;
    ...
    std::cout << "xgboost detector, current status is stopping: " << res << " using time(ms) " << ms2 - ms << std::endl;

    unit test int data_size = 45461;
    ...
    std::string file =
        "D:\\worksheet\\clion\\Location\\test\\data\\sensor_log\\origin_sensors_data_1558592729003.9297.csv";
